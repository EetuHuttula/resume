            ...
            <div className="col-12 col-lg-5">
              <div className="row">
                <div className="col-12 col-xl-11">
                  <h3 className="fs-6 text-secondary mb-3 mb-xl-4 text-uppercase">Palvelut</h3>
                  <h2 className="display-5 mb-3 mb-xl-4">Tarjoamme kattavia ratkaisuja liiketoimintasi menestykseen.</h2>
                  <p className="mb-3 mb-xl-4">Palvelumme on suunniteltu vastaamaan kaikkiin tarpeisiisi ja auttamaan sinua menestymään dynaamisessa liiketoimintaympäristössä. Ota yhteyttä tänään ja aloita kasvun, innovoinnin ja ainutlaatuisen tuen matka. Menestyksesi on prioriteettimme.</p>
                </div>
              </div>
            </div>
              ...
              <div className="row gy-4">
                <div className="col-12 col-sm-6">
                  <div className="card border-0 border-bottom border-primary shadow-sm">
                    <div className="card-body text-center p-4 p-xxl-5 card-Height">
